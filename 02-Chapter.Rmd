...
The functions in the **dplyr** package as part of the **tidyverse** set of packages simplify data munging tasks. But they work only on data frames. 
...
### Give it a try: Florida precipitation (http://myweb.fsu.edu/jelsner/temp/data/FLprecip.txt)
...
### Another example: Hot days in Tallahassee
