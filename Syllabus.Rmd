...
This course is for students who want to be able to analyze, model, and map spatial data using the R programming language. It assumes students know statistics through linear regression and they have some prior experience with using R. Students without knowledge of R should seek help through online tutorials.

This course is a survey of the methods used to describe, analyze, and model spatial data. The focus is on applications. Emphasis is given to how spatial statistical methods are related. Topics include diagnostics and models for lattice data, point pattern data, and geostatistical data.
...
Most class time will be spent working through the R code in the lesson notes. The lesson notes are comprehensive. The lesson notes are written using markdown. Markdown is a way to write content for the Web. Each lesson is contained in a file having the suffix `.Rmd` (an R markdown file) within a RStudio Cloud project with the same name. 

### Course materials

* You will need access to the internet and a laptop computer (an iPad should work).
* All course materials are available through RStudio Cloud (https://rstudio.cloud/spaces/40772/projects).
...
- Bring your laptop/iPad to class every day
...
2. Handing in the assignments on time

Grades are determined solely by how well you do on the assignments.
...
1. Wrangling data and making graphs (~ 2 weeks)
2. Working with spatial data and making maps (~ 2 weeks)
3. Quantifying spatial autocorrelation and spatial regression (~ 2 weeks)
4. Analyzing and modeling point pattern data (~ 3 weeks)
5. Estimating a variogram and spatial interpolation (~ 3 weeks)
...
* 3D elevation with ray shader: https://www.rayshader.com/
...
* tmaptools::geocode_OSM("Florida State University")
