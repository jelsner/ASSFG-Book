...
* Course materials are available through Canvas and GitHub.
* There is no required textbook.
* There are many excellent online resources. Here are some of my favorites.
...
During each lesson I will work through and explain the R code within an Rmd file. The notes are comprehensive and you can work through them on your own. The notes are written using markdown. Markdown is a way to write content for the Web. A markdown file has the suffix `.Rmd` (an R markdown file). The file is opened with the RStudio application.
