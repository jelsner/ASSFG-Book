...
The _vector data model_ represents the world using points, lines and polygons. These objects have discrete, well-defined borders, meaning that these data sets usually have a high level of precision (Of course precision does not imply accuracy).
...
Geographers, ecologists, demographers often use vector and raster data. 
