...
tmin.r <- raster(paste0("PRISM/PRISM_tmin_stable_4kmD2_", CCstring[i], "_bil/PRISM_tmin_stable_4kmD2_", CCstring[i], "_bil.bil"))
tmax.r <- raster(paste0("PRISM/PRISM_tmax_stable_4kmD2_", CCstring[i], "_bil/PRISM_tmax_stable_4kmD2_", CCstring[i], "_bil.bil"))
